    ...
    def mouseReleaseEvent(self, e) -> None:
        ...
        if self.tool == "can":
            ...
            if ok and text:
                ...
                style = self.main_window.fontStyleComboBox.currentText()
                if style == "Жирный":
                    font.setBold(True)
                elif style == "Курсив":
                    font.setItalic(True)
                elif style == "Подчеркнутый":
                    font.setUnderline(True)
                elif style == "Жирный курсив":
                    font.setBold(True)
                    font.setItalic(True)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.fontStyleComboBox.setFixedWidth(120)
        self.fontStyleComboBox.addItem("Обычный")
        self.fontStyleComboBox.addItem("Жирный")
        self.fontStyleComboBox.addItem("Курсив")
        self.fontStyleComboBox.addItem("Подчеркнутый")
        self.fontStyleComboBox.addItem("Жирный курсив")
        self.drawingToolbar.addWidget(self.fontStyleComboBox)
